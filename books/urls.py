...
urlpatterns = [
    ...
    path('add-favourite/', views.AddFavouriteView.as_view(), name='book_add_favourite'),
    path('<int:pk>/remove-favourite/', views.RemoveFavouriteView.as_view(), name='remove_favourite'),
